...
export const linkItems: LinkItemType[] = [
    {
        text: 'Give Feedback',
        url: 'https://feedback.kyber.gg',
        external: true,
        secondary: true,
        icon: (
            <svg aria-label="Featurebase Logo" className="h-5 w-5" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return {
        nav: {
            ...
            title: (
                <>
                    {logo}
                    <span className="font-medium in-[.uwu]:hidden">KYBER Docs</span>
                </>
            ),
        },
        links: linkItems,
