...
```lua linkTypes
MapRotation.AddMap(level: string, mode: string): void
```
...
```lua linkTypes
MapRotation.Clear(level: string, mode: string): void
```
...
```lua linkTypes
MapRotation.GetNextMap(): MapRotationEntry
```
...
```lua linkTypes
MapRotation.RemoveNextMap(): void
```
...
```lua linkTypes
MapRotation.GetCurrentEntryIndex(): integer
```
...
```lua linkTypes
MapRotation.GetList(): MapRotationEntry
```
