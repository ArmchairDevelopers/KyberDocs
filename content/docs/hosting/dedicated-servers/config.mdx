---
title: Configuring and run your server
...
| KYBER\_SERVER\_PASSWORD      | `string`                                                                                                          | (Optional) The server password (UTF-8, ≤64 characters)                                                                                                           |
...
| KYBER\_LOG\_LEVEL            | `string`                                                                                                          | (Optional) Sets the logging verbosity. Supported values (ordered by severity): `trace`, `debug`, `info`, `warning`, `error`, `fatal`. Defaults to `info`.        |
